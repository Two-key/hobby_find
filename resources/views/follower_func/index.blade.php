...
<x-app-layout>
    <body>
        <main>
            ...
            <div class="pl-20">
                <div class="bg-contain" style="background-image: url('https://res.cloudinary.com/dpbph7hyn/image/upload/v1693719210/tresuar_ziv4o5.png'); height: 380px"></div>
            </div>
            <div class="absolute bottom-0 left-0 right-0 top-12 h-fit w-full overflow-hidden bg-fixed" style="background-color: rgba(0, 0, 255, 0)">
