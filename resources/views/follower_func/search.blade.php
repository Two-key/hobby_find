...
<x-app-layout>
    <body>
        <h2 class="pt-52">
            <div class="bg-contain" style="background-image: url('https://res.cloudinary.com/dpbph7hyn/image/upload/v1693728649/Untitled_design_ozjc9e.svg'); height: 300px"></div>
        </h2>
